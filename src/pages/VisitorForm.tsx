  ...
  return (
    <Layout>
      ...
      <div className="relative min-h-[calc(100vh-8rem)]">
        ...
        <div className="relative z-10 container mx-auto px-4 py-8 max-w-2xl animate-fade-in">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-white/80 mt-3 max-w-md mx-auto drop-shadow-lg">
